...
test("notification has a proper message and type", async () => {
  /* Test success type */
  render(
    <Notification type="success" message="This notification was successful" />,
  );
  ...
  render(
    <Notification
      type="failure"
      message="This notification informs about a failure"
    />,
  );
  screen.getByText("This notification informs about a failure", {
    exact: false,
  });
